"""Normalize offline MHDB skill, equipment, charm, and decoration snapshots."""
...
def normalize_files(
    *,
    ...
    charm_value = json.loads(charms_input_path.read_text(encoding="utf-8"))
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("charms_input_json", type=Path)
    ...
    normalize_files(
        ...
        charms_input_path=args.charms_input_json,
